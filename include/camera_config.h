...
constexpr camera_config_t esp32cam = camera_config_t{
    .pin_pwdn = -1,
    .pin_reset = 15,
    .pin_xclk = 27,
    .pin_sscb_sda = 25,
...
constexpr camera_config_t ai_thinker = camera_config_t{
    .pin_pwdn = 32,
    .pin_reset = -1,
    .pin_xclk = 0,
    .pin_sscb_sda = 26,
...
constexpr camera_config_t ttgo_cam = camera_config_t{
    .pin_pwdn = 26,
    .pin_reset = -1,
    .pin_xclk = 32,
    .pin_sscb_sda = 13,
